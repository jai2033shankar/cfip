...
const techLogos = ['Java', '.NET', 'Python', 'COBOL', 'Fortran', 'PL/I', 'RPG', 'SQL', 'TypeScript', 'Go', 'Kotlin'];
      ...
      <section id="architecture" style={{ padding: '80px 48px', background: 'var(--bg-primary)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '1rem' }}>
              Air-gapped, on-prem deployment with full control — from legacy COBOL parsing to AI-powered modernization.
            </p>
          </div>
          <div className="glass-card-static" style={{ padding: '24px', display: 'flex', justifyContent: 'center' }}>
            <img
              src="/architecture-diagram.png"
              alt="CFIP System Architecture — 6-layer stack from Presentation to Infrastructure"
