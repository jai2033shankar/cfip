...
import {
    ...
    FiFolder, FiAlertTriangle, FiTarget, FiBookOpen, FiTerminal, FiBriefcase, FiMessageSquare, FiCode
} from 'react-icons/fi';
...
const navItems = [
    ...
    { href: '/dashboard/legacy', icon: <FiCode />, label: 'Legacy Analyzer', badge: 'New' },
                ...
                <aside className={`sidebar ${collapsed ? 'collapsed' : ''}`}>
                    ...
                    <nav className="sidebar-nav">
                        {navItems.map((item, i) => {
                            ...
                            else if (item.href === '/dashboard/legacy') navId = 'tour-nav-legacy';
