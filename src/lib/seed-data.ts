...
export const dashboardStats = {
  ...
  codebaseLanguages: [
    { language: 'Java', percentage: 38, files: 497 },
    { language: 'Python', percentage: 22, files: 287 },
    { language: 'COBOL', percentage: 14, files: 187 },
    { language: 'TypeScript', percentage: 12, files: 157 },
    { language: 'SQL', percentage: 8, files: 105 },
    { language: 'Fortran', percentage: 3, files: 40 },
    { language: 'Other', percentage: 3, files: 33 },
  ],
  riskTrend: [
...
// ========================
export const legacyRepositories: Repository[] = [
  {
    id: 'repo-legacy-1',
    name: 'core-batch-cobol',
    url: 'https://github.com/acme-bank/core-batch-cobol',
    language: 'COBOL',
    lastScanned: '2026-03-18T22:00:00Z',
    healthScore: 42,
    totalFiles: 187,
    totalFunctions: 834,
    totalClasses: 45,
    riskProfile: { critical: 28, high: 56, medium: 72, low: 31 },
    status: 'scanned',
  },
  {
    id: 'repo-legacy-2',
    name: 'interest-calc-fortran',
    url: 'https://github.com/acme-bank/interest-calc-fortran',
    language: 'Fortran',
    lastScanned: '2026-03-17T14:30:00Z',
    healthScore: 55,
    totalFiles: 64,
    totalFunctions: 312,
    totalClasses: 18,
    riskProfile: { critical: 8, high: 22, medium: 34, low: 45 },
    status: 'scanned',
  },
];

export const legacyGraphNodes: GraphNode[] = [
  // COBOL Modules
  { id: 'mod-cobol-batch', label: 'COBOL Batch Processing', type: 'module', risk: 'critical', module: 'legacy-batch', businessMapping: 'Batch Processing', description: 'Core batch transaction processing system (COBOL)' },
  { id: 'mod-cobol-reporting', label: 'COBOL Report Generator', type: 'module', risk: 'high', module: 'legacy-reporting', businessMapping: 'Regulatory Reporting', description: 'Legacy regulatory report generation (COBOL)' },
  { id: 'mod-cobol-ledger', label: 'COBOL General Ledger', type: 'module', risk: 'critical', module: 'legacy-accounting', businessMapping: 'Financial Accounting', description: 'Mainframe general ledger system (COBOL)' },

  // COBOL Programs (Services)
  { id: 'svc-cobol-txn', label: 'TXNPROC', type: 'service', risk: 'critical', module: 'legacy-batch', description: 'Main batch transaction processor program', metrics: { loc: 8450, complexity: 78, maintainability: 32, testCoverage: 15 } },
  { id: 'svc-cobol-rpt', label: 'RPTGEN', type: 'service', risk: 'high', module: 'legacy-reporting', description: 'Regulatory report generation program', metrics: { loc: 4200, complexity: 52, maintainability: 40, testCoverage: 22 } },
  { id: 'svc-cobol-ledger', label: 'LEDGPOST', type: 'service', risk: 'critical', module: 'legacy-accounting', description: 'General ledger posting program', metrics: { loc: 6100, complexity: 65, maintainability: 35, testCoverage: 18 } },

  // COBOL Paragraphs (Functions)
  { id: 'fn-cobol-validate', label: 'VALIDATE-TRANSACTION()', type: 'function', risk: 'critical', module: 'legacy-batch', description: 'COBOL paragraph for transaction validation', metrics: { loc: 340, complexity: 28, testCoverage: 10 } },
  { id: 'fn-cobol-calc-interest', label: 'CALC-INTEREST()', type: 'function', risk: 'high', module: 'legacy-batch', description: 'Interest calculation paragraph using BCD arithmetic', metrics: { loc: 180, complexity: 15, testCoverage: 25 } },
  { id: 'fn-cobol-post-entry', label: 'POST-LEDGER-ENTRY()', type: 'function', risk: 'critical', module: 'legacy-accounting', description: 'Double-entry ledger posting paragraph', metrics: { loc: 290, complexity: 22, testCoverage: 12 } },
  { id: 'fn-cobol-format-rpt', label: 'FORMAT-REPORT()', type: 'function', risk: 'high', module: 'legacy-reporting', description: 'Report formatting and output paragraph', metrics: { loc: 520, complexity: 35, testCoverage: 8 } },

  // Copybooks
  { id: 'cpy-account-rec', label: 'ACCT-REC.cpy', type: 'file', risk: 'high', module: 'legacy-batch', description: 'Account record copybook (shared across 23 programs)', language: 'COBOL' },
  { id: 'cpy-txn-rec', label: 'TXN-REC.cpy', type: 'file', risk: 'critical', module: 'legacy-batch', description: 'Transaction record copybook (shared across 31 programs)', language: 'COBOL' },
  { id: 'cpy-error-handler', label: 'ERR-HANDLER.cpy', type: 'file', risk: 'medium', module: 'legacy-batch', description: 'Error handling copybook', language: 'COBOL' },

  // DB Tables (VSAM/DB2)
  { id: 'db-cobol-master', label: 'ACCT-MASTER (VSAM)', type: 'db_table', risk: 'critical', module: 'legacy-batch', description: 'VSAM master account file' },
  { id: 'db-cobol-txnlog', label: 'TXN-LOG (DB2)', type: 'db_table', risk: 'critical', module: 'legacy-batch', description: 'DB2 transaction log table' },
];

export const legacyGraphEdges: GraphEdge[] = [
  // COBOL module dependencies
  { id: 'le1', source: 'mod-cobol-reporting', target: 'mod-cobol-batch', type: 'depends_on', criticality: 'high', weight: 5 },
  { id: 'le2', source: 'mod-cobol-ledger', target: 'mod-cobol-batch', type: 'depends_on', criticality: 'high', weight: 5 },
  { id: 'le3', source: 'mod-cobol-batch', target: 'mod-core-banking', type: 'depends_on', criticality: 'high', weight: 4 },

  // Program calls
  { id: 'le4', source: 'svc-cobol-txn', target: 'fn-cobol-validate', type: 'calls', criticality: 'high', weight: 5 },
  { id: 'le5', source: 'svc-cobol-txn', target: 'fn-cobol-calc-interest', type: 'calls', criticality: 'high', weight: 4 },
  { id: 'le6', source: 'svc-cobol-txn', target: 'fn-cobol-post-entry', type: 'calls', criticality: 'high', weight: 5 },
  { id: 'le7', source: 'svc-cobol-rpt', target: 'fn-cobol-format-rpt', type: 'calls', criticality: 'high', weight: 4 },
  { id: 'le8', source: 'svc-cobol-ledger', target: 'fn-cobol-post-entry', type: 'calls', criticality: 'high', weight: 5 },

  // Copybook imports
  { id: 'le9', source: 'svc-cobol-txn', target: 'cpy-account-rec', type: 'depends_on', criticality: 'high', weight: 3 },
  { id: 'le10', source: 'svc-cobol-txn', target: 'cpy-txn-rec', type: 'depends_on', criticality: 'high', weight: 3 },
  { id: 'le11', source: 'svc-cobol-rpt', target: 'cpy-txn-rec', type: 'depends_on', criticality: 'medium', weight: 2 },
  { id: 'le12', source: 'svc-cobol-txn', target: 'cpy-error-handler', type: 'depends_on', criticality: 'medium', weight: 2 },

  // DB access
  { id: 'le13', source: 'fn-cobol-validate', target: 'db-cobol-master', type: 'reads_from', criticality: 'high', weight: 5 },
  { id: 'le14', source: 'fn-cobol-post-entry', target: 'db-cobol-txnlog', type: 'writes_to', criticality: 'high', weight: 5 },
  { id: 'le15', source: 'fn-cobol-format-rpt', target: 'db-cobol-txnlog', type: 'reads_from', criticality: 'high', weight: 4 },
];

export const legacyRiskItems: RiskItem[] = [
  {
    id: 'risk-legacy-1',
    nodeId: 'svc-cobol-txn',
    type: 'Maintainability',
    severity: 'critical',
    title: 'TXNPROC contains 47 GO TO statements',
    description: 'The main batch transaction processor uses 47 GO TO statements creating spaghetti control flow. No structured programming constructs (PERFORM THRU) are used consistently.',
    businessImpact: 'Engineering velocity — average change to TXNPROC takes 3 weeks due to unstructured control flow',
    affectedDownstream: 31,
    recommendation: 'Refactor GO TO statements to structured PERFORM paragraphs. Consider modernization to Java batch framework (Spring Batch).',
    estimatedEffort: '20-30 days',
    category: 'maintenance',
  },
  {
    id: 'risk-legacy-2',
    ...
    type: 'Architecture',
    severity: 'critical',
    title: 'TXN-REC copybook shared by 31 programs',
    description: 'The TXN-REC.cpy copybook is COPYed by 31 different COBOL programs. Any change to the record layout requires recompilation and regression testing of all 31 programs.',
    businessImpact: 'Change risk — single field addition requires full batch suite regression ($150K+ testing cost)',
    affectedDownstream: 31,
    recommendation: 'Implement copybook versioning strategy. Migrate to standardized data contract (Protobuf/Avro) for new integrations.',
    estimatedEffort: '15-20 days',
    category: 'architecture',
  },
  {
    id: 'risk-legacy-3',
    nodeId: 'fn-cobol-calc-interest',
    type: 'Compliance',
    severity: 'high',
    title: 'Y2K-era date fields in interest calculation',
    description: 'CALC-INTEREST paragraph uses PIC 9(2) for year fields (WS-YEAR). While patched for Y2K, the 2-digit field will overflow again in 2100 and causes issues with 100-year mortgage calculations.',
    businessImpact: 'Compliance risk — long-term date calculations produce incorrect results for 30+ year instruments',
    affectedDownstream: 12,
    recommendation: 'Replace PIC 9(2) year fields with PIC 9(4). Update all date arithmetic to use full 4-digit years.',
    estimatedEffort: '5-7 days',
    category: 'compliance',
  },
  {
    ...
    type: 'Reliability',
    severity: 'high',
    title: 'No error handling in VSAM file operations',
    description: 'TXNPROC performs VSAM READ/WRITE operations without checking FILE STATUS codes. I/O errors silently continue, potentially corrupting master records.',
    businessImpact: 'Data integrity — silent VSAM corruption has caused 3 incidents in the past year ($200K recovery cost)',
    affectedDownstream: 18,
    recommendation: 'Add FILE STATUS checking after every VSAM operation. Implement ERR-HANDLER copybook consistently.',
    estimatedEffort: '8-10 days',
    category: 'reliability',
  },
  {
    id: 'risk-legacy-5',
    nodeId: 'svc-cobol-ledger',
    type: 'Security',
    severity: 'high',
    title: 'Hardcoded DB2 credentials in LEDGPOST',
    description: 'The LEDGPOST program contains hardcoded DB2 connection credentials in the WORKING-STORAGE SECTION. These credentials have not been rotated in 4 years.',
    businessImpact: 'Security breach risk — compromised credentials could expose entire general ledger',
    affectedDownstream: 8,
    recommendation: 'Move credentials to CICS transaction security facility. Implement credential rotation via vault.',
    estimatedEffort: '3-5 days',
    category: 'security',
  },
];

export const legacyRemediations: RemediationSuggestion[] = [
  {
    id: 'rem-legacy-1',
    title: 'Modernize COBOL Batch to Java Spring Batch',
    category: 'architecture',
    confidence: 78,
    riskReduction: 45,
    effort: 'high',
    effortDays: 60,
    description: 'Migrate TXNPROC COBOL batch program to Java Spring Batch framework with modern error handling, retry logic, and observability. Maintain backward compatibility with existing JCL orchestration.',
    affectedFiles: ['TXNPROC.cbl', 'TXN-REC.cpy', 'ACCT-REC.cpy'],
    pattern: 'Strangler Fig + Anti-Corruption Layer',
    priority: 1,
  },
  {
    id: 'rem-legacy-2',
    title: 'Eliminate GO TO Spaghetti with PERFORM Refactoring',
    category: 'refactoring',
    confidence: 92,
    riskReduction: 32,
    effort: 'medium',
    effortDays: 15,
    description: 'Systematically replace all GO TO statements with structured PERFORM and EVALUATE constructs. Apply COBOL-85 structured programming patterns.',
    affectedFiles: ['TXNPROC.cbl', 'RPTGEN.cbl', 'LEDGPOST.cbl'],
    pattern: 'Structured Programming Refactoring',
    priority: 2,
  },
  {
    id: 'rem-legacy-3',
    title: 'Implement Copybook Versioning Strategy',
    category: 'architecture',
    confidence: 85,
    riskReduction: 28,
    effort: 'medium',
    effortDays: 10,
    description: 'Add version suffixes to high-impact copybooks (TXN-REC-V2.cpy). Implement backward-compatible record layouts with REDEFINES for gradual migration.',
    affectedFiles: ['TXN-REC.cpy', 'ACCT-REC.cpy'],
    pattern: 'Versioned Data Contract',
    priority: 3,
  },
  {
    id: 'rem-legacy-4',
    title: 'Add VSAM FILE STATUS Error Handling',
    category: 'refactoring',
    confidence: 96,
    riskReduction: 38,
    effort: 'low',
    effortDays: 5,
    description: 'Add FILE STATUS checking after every VSAM I/O operation with standardized error logging via ERR-HANDLER copybook.',
    affectedFiles: ['TXNPROC.cbl', 'LEDGPOST.cbl', 'ERR-HANDLER.cpy'],
    pattern: 'Defensive I/O Pattern',
    priority: 4,
  },
];
