...
export default function ProductTour({ run, setRun }: ProductTourProps) {
    ...
    const steps: Step[] = [
        ...
        },
        {
            ...
            content: 'Analyze COBOL, Fortran, PL/I, and RPG codebases. Auto-detect legacy languages, identify GO TO spaghetti, Y2K-era patterns, and get AI-powered modernization recommendations.',
            placement: 'right',
        },
        {
